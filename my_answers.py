...
class NeuralNetwork(object):
    ...
    def run(self, features):
        ...
        final_inputs = np.dot(hidden_outputs, self.weights_hidden_to_output) #np.dot(self.weights_hidden_to_output.T, hidden_outputs.T) # None # signals into final output layer
